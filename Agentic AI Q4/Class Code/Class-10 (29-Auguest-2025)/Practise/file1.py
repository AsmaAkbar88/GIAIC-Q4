# github link
# https://github.com/panaversity/learn-agentic-ai/blob/main/01_ai_agents_first/15_advanced_tools/tools_masterclass/part1.py
...
# 1. llm--->tool--->llm = F.O
# Weather in Lahore is Sunny and beautiful.

# 2. llm--->tool = F.O
# Travel Plan is not available
